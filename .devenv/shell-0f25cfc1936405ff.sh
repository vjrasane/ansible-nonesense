...
export shell
XDG_DATA_DIRS='/nix/store/0550j0i8bmzxbcnzrg1g51zigj7y12ih-bash-interactive-5.3p9/share:/nix/store/b87dfjnjvg932xsw4mszjg4qmvrqzlqk-nodejs-22.22.0/share:/nix/store/f2fcs5sgi5jd8gpds8axpwhbg183ifmz-pnpm-10.28.0/share:/nix/store/dlwmqm36lpzwlvp67lvjmdxs5yjmr80h-python3.13-ansible-core-2.20.0/share:/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/share:/nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2/share:/nix/store/590yx3aynyhs48jyk8ip37fk1mjqfhkb-patchelf-0.15.2/share'
...
DEVENV_PROFILE='/nix/store/ir4dxq4l8cw2pmzjcd09idqdn749a1wq-devenv-profile'
export DEVENV_PROFILE
NIX_CFLAGS_COMPILE=' -frandom-seed=07l5rnbkcm -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/b87dfjnjvg932xsw4mszjg4qmvrqzlqk-nodejs-22.22.0/include -isystem /nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/include -isystem /nix/store/5i226lbgs0d6i20bz9qzmpmvhbj6ahx2-libssh-0.11.3-dev/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/b87dfjnjvg932xsw4mszjg4qmvrqzlqk-nodejs-22.22.0/include -isystem /nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/include -isystem /nix/store/5i226lbgs0d6i20bz9qzmpmvhbj6ahx2-libssh-0.11.3-dev/include'
...
prefix='/nix/store/07l5rnbkcm79ck4fsk3li5g406a0jpc1-devenv-shell-env'
OSTYPE='linux-gnu'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/ir4dxq4l8cw2pmzjcd09idqdn749a1wq-devenv-profile" ]
then
  ln -snf /nix/store/ir4dxq4l8cw2pmzjcd09idqdn749a1wq-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
exec bash -c 'ANSIBLE_LOAD_CALLBACK_PLUGINS=true ANSIBLE_STDOUT_CALLBACK=json ansible localhost -i "localhost," -m ansible.builtin.debug -a "{\"msg\": \"hello\"}" --connection local 2>/dev/null'