...
export system
OSTYPE='linux-gnu'
out='/nix/store/jdk35b9ai4bpw4c81rb1slsp36hvfarg-devenv-shell-env'
export out
DEVENV_DOTFILE='/home/ville/repositories/nonesible/.devenv'
export DEVENV_DOTFILE
declare -a preFixupHooks=('_moveToShare' '_multioutDocs' '_multioutDevs' )
NIX_CFLAGS_COMPILE=' -frandom-seed=jdk35b9ai4 -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/sy0c7j0npsq33d9zhnnzvjnzc52f4y0p-nodejs-24.13.0/include -isystem /nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/include -isystem /nix/store/5i226lbgs0d6i20bz9qzmpmvhbj6ahx2-libssh-0.11.3-dev/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/sy0c7j0npsq33d9zhnnzvjnzc52f4y0p-nodejs-24.13.0/include -isystem /nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/include -isystem /nix/store/5i226lbgs0d6i20bz9qzmpmvhbj6ahx2-libssh-0.11.3-dev/include'
...
SHELL='/nix/store/2hjsch59amjs3nbgh7ahcfzm2bfwl8zi-bash-5.3p9/bin/bash'
export SHELL
prefix='/nix/store/jdk35b9ai4bpw4c81rb1slsp36hvfarg-devenv-shell-env'
NIX_STORE='/nix/store'
export NIX_STORE
...
SIZE='size'
export SIZE
DEVENV_PROFILE='/nix/store/wrywjnzf1cn2iw2qg5f1x7jbgssp0pbh-devenv-profile'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/wrywjnzf1cn2iw2qg5f1x7jbgssp0pbh-devenv-profile" ]
then
  ln -snf /nix/store/wrywjnzf1cn2iw2qg5f1x7jbgssp0pbh-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
exec bash -c 'cd packages/core && npx vitest run src/module.test.ts'