...
exec python3 packages/codegen/codegen.py ansible.builtin packages/bindings/builtin/src copy command file template service apt debug shell uri stat lineinfile