...
prefix='/nix/store/9cdikbjx2dwvbjakwz07hr07yaizhgqg-devenv-shell-env'
NIX_LDFLAGS='-rpath /nix/store/9cdikbjx2dwvbjakwz07hr07yaizhgqg-devenv-shell-env/lib  -L/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/lib -L/nix/store/zgmka7zcmx7442rashrdqdksl7sya9fv-libssh-0.11.3/lib -L/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/lib -L/nix/store/zgmka7zcmx7442rashrdqdksl7sya9fv-libssh-0.11.3/lib'
export NIX_LDFLAGS
DEVENV_PROFILE='/nix/store/0dj7w4vpk565d8whn0kyawsr2q94rfs3-devenv-profile'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/0dj7w4vpk565d8whn0kyawsr2q94rfs3-devenv-profile" ]
then
  ln -snf /nix/store/0dj7w4vpk565d8whn0kyawsr2q94rfs3-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
strictDeps=''
export strictDeps
out='/nix/store/9cdikbjx2dwvbjakwz07hr07yaizhgqg-devenv-shell-env'
export out
