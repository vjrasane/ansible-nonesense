// Auto-generated from: community.general.oneview_datacenter_info
// DO NOT EDIT — regenerate with codegen

import { defineModule } from "@sensible-ts/core";

export interface OneviewDatacenterInfoArgs {
  /** OneView API Version. */
  api_version?: number;
...
export interface OneviewDatacenterInfoReturn {
  /** Has information about the Data Center Visual Content. */
  datacenter_visual_content?: Record<string, unknown>;
  /** Has all the OneView information about the Data Centers. */
  datacenters?: Record<string, unknown>;
}

export const oneview_datacenter_info = defineModule<OneviewDatacenterInfoArgs, OneviewDatacenterInfoReturn>("community.general.oneview_datacenter_info");
