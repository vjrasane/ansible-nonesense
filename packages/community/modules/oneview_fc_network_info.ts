// Auto-generated from: community.general.oneview_fc_network_info
// DO NOT EDIT — regenerate with codegen

import { defineModule } from "@sensible-ts/core";

export interface OneviewFcNetworkInfoArgs {
  /** OneView API Version. */
  api_version?: number;
...
export interface OneviewFcNetworkInfoReturn {
  /** Has all the OneView information about the Fibre Channel Networks. */
  fc_networks?: Record<string, unknown>;
}

export const oneview_fc_network_info = defineModule<OneviewFcNetworkInfoArgs, OneviewFcNetworkInfoReturn>("community.general.oneview_fc_network_info");
